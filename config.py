...
API_ID = int(getenv("API_ID", "23156684"))
API_HASH = getenv("API_HASH", None)
BOT_TOKEN = getenv("BOT_TOKEN", None)
OWNER_ID = 7808531413
MONGO_URL = getenv("MONGO_URL", None)
AUTH_CHANNEL = int(getenv("AUTH_CHANNEL", "-1002267118144"))  # Fsub Channel Id
...
LOGGER_GROUP_ID = -1003996256161 # Bot Events Logs

SUPPORT_GROUP = os.environ.get("SUPPORT_GROUP", "ixasta1")
UPDATES_CHANNEL = os.environ.get("UPDATES_CHANNEL", "ixasta1")
