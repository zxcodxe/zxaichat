...
ABOUT_BUTTON = [
    [
        InlineKeyboardButton("⌯ 𝛅ᴜᴘᴘσʀᴛ ⌯", url=f"https://t.me/ixasta1"),
        InlineKeyboardButton("⌯ ᴜᴘᴅᴧᴛє ⌯", url=f"https://t.me/ixasta1")
    ],
    [
...
HELP_BACK = [
    ...
    [
        InlineKeyboardButton(text="𝛅ᴜᴘᴘᴏʀᴛ", url=f"https://t.me/ixasta1"),
...
├────────────────────⦿
│❖ ϻᴧᴅє ʙʏ...[˹ᴀsᴛᴀ ꭙ ꜱᴜᴘᴘᴏʀᴛ˼](t.me/{SUPPORT_GROUP})♡
╰────────────────────⦿**
"""
...
❖ sυᴘᴘσʀᴛ ᴄʜᴧᴛ ➥ [˹ᴀsᴛᴀ ꭙ ꜱᴜᴘᴘᴏʀᴛ˼](https://t.me/ixasta1)
❖ ᴍᴜsɪᴄ ʙᴏᴛ ➥ [˹ʟᴧɪʙᴧ ꭙ ϻᴜꜱɪᴄ˼ ♪](https://t.me/Laibaamusicbot)
❖ ʙᴏᴛ σᴡηєʀ ➥ [⎯᪵፝֟፝֟⎯꯭𓆩꯭ ᴀsᴛᴀ⎯꯭꯭‌꯭🥂꯭༎꯭ 𓆪](https://t.me/zxasta)
❖ ʀєᴘσ ʟɪηᴋ ➥ [ᴄʟɪᴄᴋ-ʜєʀє](github.com/ASTA/ASTA_CHAT)
─────────────────────────**
"""
...
async def start(client, m: Message):
    ...
    if m.chat.type == ChatType.PRIVATE:
        ...
        asta = await m.reply_text(text="**ꜱᴛᴧʀᴛɪηɢ....🥀**")
        await asyncio.sleep(1)
        await asta.edit("**ᴘɪηɢ ᴘσηɢ...🍫**")
        await asyncio.sleep(0.5)
        await asta.edit("**ꜱᴛᴧʀᴛєᴅ.....😱**")
        await asyncio.sleep(0.5)
        await asta.delete()
...
async def on_new_chat_members(client: Client, message: Message):
    if (await client.get_me()).id in [user.id for user in message.new_chat_members]:
        ...
        try:
            ...
            invite_link = f"https://t.me/ixasta1"
        ...
        await message.reply_photo(
            ...
            reply_markup=InlineKeyboardMarkup([
                [
                    ...
                    InlineKeyboardButton("sᴜᴘᴘσʀᴛ", url=f"https://t.me/ixasta1")
                ]
            ])
        )
...
async def on_left_chat_member(client: Client, message: Message):
    if (await client.get_me()).id == message.left_chat_member.id:
        ...
        await app.send_photo(
            ...
            caption=left_msg,
            reply_markup=InlineKeyboardMarkup([
                [InlineKeyboardButton("sᴇᴇ ɢʀᴏᴜᴘ", url=f"https://t.me/{message.chat.username}" if message.chat.username else f"https://t.me/ixasta1")]
            ])
        )
    ...
    hmm = await message.reply_photo(
        ...
        reply_markup=InlineKeyboardMarkup([
            [
                ...
                InlineKeyboardButton("💬 sᴜᴘᴘᴏʀᴛ", url=f"https://t.me/ixasta1")
            ]
        ])
    )
